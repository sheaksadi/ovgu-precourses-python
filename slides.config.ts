...
export const slides: SlideEntry[] = [
  ...
  },
  {
    ...
    teleprompter: 'Ohne Python beginnen. 135 Minuten als zwei volle 60er-Gruppen und 15 Restminuten zeichnen. Erst 60 und 59 vorhersagen lassen. Zu zweit genaue Anweisungen formulieren und wörtlich ausführen: Was fehlt bei „Rechne die Stunden aus“? Danach Werte unter minuten, stunden und rest notieren. Grundlagen zeichnet und ergänzt; Aufbau schreibt den Plan selbst; Vertiefung prüft zusätzlich 0 und 61. Nach den Variablen zum Auftrag zurückkehren und erst dann // und % zeigen.',
  },
  {
    id: 'PRE-0039',
    title: 'Montag: Vorhersagen, dann ausführen',
    subtitle: 'Ausgabe vermuten, ausführen, vergleichen',
    duration: 5,
    teleprompter: 'Vor Run die Ausgabe von print vorhersagen. Danach vergleichen und genau eine Änderung testen. Keine Installation im Unterricht: Bei Problemen nach spätestens fünf Minuten Partner- oder Papiermodus. Anschließend untersuchen, wie Namen Werte speichern.',
  },
  {
    id: 'PRE-0040',
    title: 'Montag: Werte merken',
    duration: 15,
    teleprompter: 'Unser Minutenplan braucht Namen für Eingabe und Ergebnisse. Zuerst an einem kurzen Gruß üben: Was wird gespeichert, was schon ausgegeben? Zuweisung allein zeigt nichts an. Anschließend minuten, stunden und rest im eigenen Plan markieren.',
  },
  {
    id: 'PRE-0041',
  ...
  },
  {
    ...
    teleprompter: 'Neuer Tag: erst wiederholen, dann Grenzen auf dem Zahlenstrahl markieren. Vor jeder Syntax die Meldungen für 19, 20, 24, 25 und 26 begründen lassen. Grundlagen nutzt nur unter 20 kühl, sonst nicht kühl. Aufbau nutzt drei Fälle. Vertiefung findet einen Gegenfall zur falschen Reihenfolge: >= 20 vor >= 25. Danach erklärt Momo dieselbe Idee mit zwei Wegen; nach der Python-Folie auf diesen Auftrag zurückkommen und testen.',
  },
  {
    id: 'PRE-0034',
    title: 'Dienstag: Eine Frage, zwei Wege',
    subtitle: 'Problem',
    teleprompter: 'An die Temperaturregel anknüpfen: Auch Momo braucht eine eindeutige Entscheidung. Schlüssel vorhanden oder nicht? Für beide Eingaben das Ergebnis vorhersagen und begründen, bevor die Bewegung gezeigt wird.',
  },
  {
    id: 'PRE-0035',
