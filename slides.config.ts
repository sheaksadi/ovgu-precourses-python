...
export const slides: SlideEntry[] = [
  ...
  {
    id: 'PRE-0198',
    title: 'Funktionen für Mathe und Physik – Formel lesbar',
    parent: 'PRE-0104',
    transition: 'none',
    teleprompter: 'Dieselbe Funktion, zweimal geschrieben. 3.14159 * r * r ist richtig und sagt nichts. Mit PI und quadrat steht in der Funktion wieder die Formel von der Tafel. Frag: Welche der beiden Zeilen würdet ihr in einem halben Jahr noch verstehen?',
  },
  {
    id: 'PRE-0105',
  ...
  {
    id: 'PRE-0199',
    title: 'Funktionen für Mathe und Physik – Kommentare',
    parent: 'PRE-0104',
    transition: 'none',
    teleprompter: 'Woher kommt das 9 / 5 + 32? Mit dem Rautezeichen schreibt man eine Notiz für Menschen. Python liest die Zeile gar nicht – sie ist nur für die, die den Code später lesen. Auch hinter Code darf ein Kommentar stehen.',
  },
  {
    id: 'PRE-0106',
    title: 'Funktionen kombinieren',
    subtitle: 'Aufrufe in Aufrufen',
    duration: 8,
    teleprompter: 'Zwei Parameter: Strecke und Zeit. Beide laufen 100 Meter, Bello ist doppelt so schnell. Die Reihenfolge der Argumente zählt: tempo(20, 100) wäre falsch.',
  },
  {
    id: 'PRE-0107',
    title: 'Funktionen kombinieren – Von innen nach außen',
    parent: 'PRE-0106',
    transition: 'none',
    teleprompter: 'Ein Aufruf darf im Aufruf stehen. Python rechnet von innen nach außen: erst die beiden Beschleunigungen, dann der Durchschnitt. Frag vorher: Was rechnet Python hier zuerst?',
  },
  {
    id: 'PRE-0200',
    title: 'Funktionen kombinieren – Anhalteweg',
    parent: 'PRE-0106',
    transition: 'none',
    teleprompter: 'Die Faustformel aus der Fahrschule. Reaktionsweg und Bremsweg sind je eine kleine Funktion, anhalteweg addiert nur noch. Die Balken zeigen: doppeltes Tempo, mehr als dreifacher Weg. Das ist der Bauplan für alles Größere – kleine Funktionen, die andere benutzen.',
  },
  {
    id: 'PRE-0144',
  ...
  },
  {
    ...
    subtitle: 'Eine Liste, die sich ändert',
    duration: 5,
    teleprompter: 'Bisher gingen Zahlen rein und raus. Hier geht eine Liste rein: tier ist keine Kopie, sondern dieselbe Liste wie momo. Deshalb ist Momo nach dem Aufruf auch draußen satter. Und: Stelle 1 ist der Hunger, weil wir das festgelegt haben – genau das lösen später die Dictionaries.',
  },
  {
    id: 'PRE-0112',
  ...
  {
    id: 'PRE-0201',
    title: 'Eingebaute Funktionen – Verkettet',
    parent: 'PRE-0113',
    transition: 'none',
    teleprompter: 'Jede Funktion gibt etwas zurück, und das darf sofort weiter in die nächste. split macht Wörter, sorted ordnet sie, join klebt sie zusammen. Gelesen wird von innen nach außen – dasselbe wie bei den verschachtelten Aufrufen. Frag: Was passiert zuerst?',
  },
  {
    id: 'PRE-0118',
  ...
  },
  {
    ...
    subtitle: 'Das Problem vor der Lösung',
    duration: 5,
    teleprompter: 'Erst das Problem. Drei Katzen, je vier Angaben, alles Listen. Frag ins Publikum: Wie alt ist Luna? Sie müssen zählen. Und dann: Was steht an Stelle 3? Das weiß niemand mehr sicher. Genau da setzen die Dictionaries an.',
  },
  {
    id: 'PRE-0119',
    title: 'Dictionaries',
  ...
  {
    id: 'PRE-0206',
    title: 'Merge Sort in voller Größe',
    parent: 'PRE-0156',
    transition: 'none',
    teleprompter: 'Die vierte Regel, und die erste, die nicht mehr stur durch die Reihe läuft: teilen, bis jeder Teil nur noch einen Wert hat, dann Hälfte für Hälfte sortiert zusammenfügen. Die Idee steht rechts oben in drei Schritten. Zuschauen, wie die grünen Blöcke erst klein sind und dann immer größer werden. Am Ende auf die Vergleiche zeigen: deutlich weniger als bei den ersten drei, und der Abstand wächst mit der Länge der Liste. Enter spielt es nochmal.',
  },
  {
    id: 'PRE-0207',
    title: 'Quick Sort in voller Größe',
    parent: 'PRE-0156',
    transition: 'none',
    teleprompter: 'Die fünfte: ein Wert wird zum Pivot – die blaue Säule –, alles Kleinere wandert nach links, alles Größere nach rechts. Danach steht das Pivot endgültig, und beide Seiten fangen für sich von vorne an. Der gestrichelte Rahmen zeigt, an welchem Stück gerade gearbeitet wird. Auch hier die Vergleiche mit Bubble Sort vergleichen. Das ist die Sortierung, die in der Praxis am häufigsten läuft. Enter spielt es nochmal.',
  },
  {
    id: 'PRE-0161',
