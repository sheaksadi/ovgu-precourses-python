...
export const slides: SlideEntry[] = [
  ...
  },
  {
    ...
    duration: 4,
    teleprompter: 'Für den Kurs brauchen wir PyCharm auf dem eigenen Rechner. Schritt 1: Browser auf, pycharm download eintippen – genau das, was alle eintippen würden – und Suchen drücken. Enter zeigt die Vorführung nochmal.',
  },
  {
    id: 'PRE-0049',
    title: 'PyCharm – Website öffnen',
    parent: 'PRE-0048',
    transition: 'none',
    teleprompter: 'Das Ergebnis von jetbrains.com anklicken, keine Anzeigen und keine Download-Portale. Die Seite öffnet oben mit PyCharm Professional – das ist nicht die, die wir wollen.',
  },
  {
    id: 'PRE-0050',
    title: 'PyCharm – Runterscrollen',
    parent: 'PRE-0048',
    transition: 'none',
    teleprompter: 'Nicht den ersten Download-Knopf drücken. Weiter nach unten scrollen, bis PyCharm Community Edition kommt. Die ist kostenlos und reicht für den ganzen Kurs.',
  },
  {
    id: 'PRE-0051',
    ...
    parent: 'PRE-0048',
    transition: 'none',
    teleprompter: 'Unter Community Edition auf Download drücken und die Datei öffnen. Windows lädt eine .exe, macOS eine .dmg, Linux ein .tar.gz. Den Installer mit den Standardeinstellungen durchklicken.',
  },
  {
    id: 'PRE-0052',
  ...
  },
  {
    ...
    duration: 8,
    transition: 'none',
    teleprompter: 'Jetzt die erste eigene Datei. Rechtsklick auf den Projektordner, New, Python File, Namen eintippen, Enter. Die .py-Endung ergänzt PyCharm selbst.',
  },
  {
    id: 'PRE-0057',
    title: 'Code ausführen – Code schreiben',
    parent: 'PRE-0056',
    transition: 'none',
    teleprompter: 'print("Hallo Welt!") in die Datei tippen. Speichern muss man nicht, PyCharm speichert automatisch. Auf Anführungszeichen und Klammern achten.',
  },
  {
    id: 'PRE-0058',
    title: 'Code ausführen – Run',
    parent: 'PRE-0056',
    transition: 'none',
    teleprompter: 'Oben auf den grünen Pfeil drücken, oder Rechtsklick in den Code und Run. Unten öffnet sich das Run-Fenster mit Hallo Welt! und exit code 0. Aufgabe: den Text ändern und nochmal ausführen.',
  },
  {
    id: 'PRE-0059',
    title: 'Listen',
