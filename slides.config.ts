...
export const slides: SlideEntry[] = [
  ...
  },
  {
    ...
    duration: 10,
    teleprompter: 'Ein Ausflug, kein Pflichtstoff: keine Aufgabe, keine Rangliste. Momos Fang liegt durcheinander. Frag zuerst: Welcher Fisch ist der längste? Bei fünf Fischen sieht man es, bei tausend nicht mehr. Sortiert sind drei Fragen plötzlich einfach: der längste ist hinten, der kürzeste vorne, die Mitte in der Mitte.',
  },
  {
    id: 'PRE-0157',
